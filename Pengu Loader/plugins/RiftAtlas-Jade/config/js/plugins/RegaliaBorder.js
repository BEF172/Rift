(() => {
  const CONFIG = {
    API_URL: "https://plugins/RiftAtlas-Jade/API/border.json",
  ...
  class RegaliaBorder {
    ...
    _applyRankedProfileSubtitle(selectedBorder) {
      ...
      try {
        ...
        // Prefer the chosen custom border tier (what you clicked in RiftAtlas-Jade),
    ...
    async showBorderModal() {
      ...
      const logoUrl = 'https://plugins/RiftAtlas-Jade/assets/logo.png';
