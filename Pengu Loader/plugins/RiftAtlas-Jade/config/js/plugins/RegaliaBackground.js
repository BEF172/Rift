...
(() => {
    ...
    class BGCM {
            ...
            video.onerror = async () => {
                ...
                try {
                    ...
                    if (window.RiftAtlasJadeLog) {
                        window.RiftAtlasJadeLog('error', "[BGCM] Failed to fallback to image background", { error: error.message || error });
                    } else {
        ...
        async showModal() {
            ...
            const logoUrl = '/plugins/RiftAtlas-Jade/assets/logo.png';
